...
module Landing
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['LANDING_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Landing::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Landing::Action is included
      ...
      # Configure the code that will yield each time Landing::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Landing::Assets::Helpers
      end
    end
